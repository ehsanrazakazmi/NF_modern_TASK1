                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <span style="font-size: 1.2em; font-weight: bold; color: #555;"><?php echo e($user->name); ?></span>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong style="font-size: 1.5em; color: #333;">Email:</strong>
                                <span style="font-size: 1.2em; color: #555;"><?php echo e($user->email); ?></span>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <div>
                                    <?php if(!empty($user->getRoleNames())): ?>
                                        <?php $__currentLoopData = $user->getRoleNames(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span style="font-size: 1.2em; font-weight: bold; color: #007BFF; margin-right: 10px;"><?php echo e($v); ?></span>
